...

{
  ...
  ORDER_STATUS result;
   ...
   if(testMode) 	cout<< "Processing orders for Entity " << entity->print() <<endl;
	...
	{
      result =instance->getCurrentlyRepeatingOrder()->process(processingMode, entity, currentRound);
...
//combatReportFile<< "Processing orders for Entity " << entity->print() <<endl;
   for( currentIterator = (instance->getCombatOrderList()).begin();
     ...
     {
//     combatReportFile << "==== Trying to process "; (*currentIterator)->save( combatReportFile );
